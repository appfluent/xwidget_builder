...
XWidget Builder is a command-line tool for generating [XWidget](https://pub.dev/packages/xwidget) 
inflaters, controllers, icons, and schema files. Additionally, it includes a tool for bootstrapping
a new XWidget project, streamlining the setup process.
