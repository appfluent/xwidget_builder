...
extension StringExt on String {
  ...
  String capitalizeFirst() {
    return isNotEmpty ? substring(0, 1).toUpperCase() + substring(1, length) : this;
  }
}
...
extension VersionExt on Version {
  String get number => '$major.$minor.$patch';
  String? get metadata => build.isNotEmpty ? build.join('.') : null;
}
